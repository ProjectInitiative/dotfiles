...
in
{
  ...
  ${namespace}.hosts.dgx-spark = {
    ...
    dhcp = false;
    ipAddress = "${config.sensitiveNotSecret.default_subnet}55/24";
    vlanIpAddress = "172.16.4.55/24";
    vlanId = 10;
    ...
    rdmaLinks = [
      {
        ...
        peerAddress = "172.16.5.56";
        peerMac = "30:c5:99:40:c4:2f";
      }
      {
        name = "enP2p1s0f1np1";
        mac = "30:c5:99:40:fb:d3";
        address = "172.16.6.55/24";
        # ConnectX port 2 → Octant port 1.
