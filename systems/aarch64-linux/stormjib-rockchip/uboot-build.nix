...
let
  ...
  trusted-firmware-a = stdenv.mkDerivation rec {
    ...
    src = pkgs.fetchgit {
      ...
      rev = "https://gitlab.collabora.com/hardware-enablement/rockchip-3588/trusted-firmware-a.git";
    ...
    buildPhase = ''
      runHook preBuild
      echo "Building BL31 for PLAT=${PLAT} with CROSS_COMPILE=${CROSS_COMPILE}"
      make bl31 ASFLAGS=""
      runHook postBuild
    '';
