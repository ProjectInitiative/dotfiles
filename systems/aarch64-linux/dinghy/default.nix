...
in
{
  ...
  services.nfs.server = {
    ...
    nproc = 8;
    exports = ''
      /export         wharfmaster.taildeab2.ts.net(rw,fsid=0,no_subtree_check,crossmnt)
      /export/frigate wharfmaster.taildeab2.ts.net(rw,nohide,insecure,no_subtree_check,no_root_squash)
    '';
  };
