...
let
  ...
  defaultRev = "09e0711c260f1d14dd439315465c495003e02b4f";
  defaultHash = "sha256-jSN8o7XxbSY/o3gyVsDtYPWGnsQedeLAI8ZzgjNJuuE=";
  ...
  validSymbols =
    pkgs.runCommand "valid-kconfig-symbols"
      {
        src = kernelSrc;
        nativeBuildInputs = [
          pkgs.gnugrep
